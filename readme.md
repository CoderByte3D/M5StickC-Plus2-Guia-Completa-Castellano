...
<tr>
  <td colspan="2" style="text-align: center; padding: 0; margin: 0;">
    ...
    <h3> Todo ésto en conjunto de sus características físicas de un peso 15g y un tamaño de 48,2 x 25,5x 13,7 mm, le convierte en un Kit de Desarrollo IOT fascinante.</h3>
